...
entity calculate_statistics_calculate_statistics_Pipeline_calc_rms is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of calculate_statistics_calculate_statistics_Pipeline_calc_rms is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln121_reg_248 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage5 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal i_4_reg_242 : STD_LOGIC_VECTOR (30 downto 0);
    signal icmp_ln121_fu_154_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_4_fu_186_p11 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_4_reg_272 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_pp0_stage1 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage1 : signal is "none";
    signal ap_block_pp0_stage1_11001 : BOOLEAN;
    signal mul1_reg_278 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage5_11001 : BOOLEAN;
    signal sum_squares_1_reg_288 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_pp0_stage4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage4 : signal is "none";
    signal ap_block_pp0_stage4_11001 : BOOLEAN;
    signal zext_ln121_1_fu_170_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal sum_squares_fu_56 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
    signal ap_block_pp0_stage5 : BOOLEAN;
    signal ap_loop_init : STD_LOGIC;
    signal i_fu_60 : STD_LOGIC_VECTOR (30 downto 0) := "0000000000000000000000000000000";
    signal add_ln121_fu_178_p2 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    signal zext_ln121_fu_150_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal lshr_ln4_fu_160_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_block_pp0_stage1 : BOOLEAN;
    signal tmp_4_fu_186_p9 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_4_fu_186_p10 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal tmp_4_fu_186_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_4_fu_186_p3 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_4_fu_186_p5 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_4_fu_186_p7 : STD_LOGIC_VECTOR (1 downto 0);
...
begin
    sparsemux_9_2_32_1_1_U42 : component calculate_statistics_sparsemux_9_2_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00",
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln121_reg_248 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0_reg = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
                i_fu_60 <= add_ln121_fu_178_p2;
            end if; 
        end if;
    end process;

    sum_squares_fu_56_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                sum_squares_fu_56 <= ap_const_lv32_0;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                icmp_ln121_reg_248 <= icmp_ln121_fu_154_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln121_fu_178_p2 <= std_logic_vector(unsigned(i_4_reg_242) + unsigned(ap_const_lv31_1));
    ...
    ap_condition_exit_pp0_iter0_stage5_assign_proc : process(ap_CS_fsm_pp0_stage5, ap_block_pp0_stage5_subdone, ap_enable_reg_pp0_iter0_reg, icmp_ln121_reg_248)
    begin
        if (((icmp_ln121_reg_248 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0_reg = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage5_subdone) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage5))) then 
    ...
    ap_sig_allocacmp_i_4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, i_fu_60)
    begin
    ...
    data_1_address0 <= zext_ln121_1_fu_170_p1(8 - 1 downto 0);
    ...
    data_2_address0 <= zext_ln121_1_fu_170_p1(8 - 1 downto 0);
    ...
    data_3_address0 <= zext_ln121_1_fu_170_p1(8 - 1 downto 0);
    ...
    data_address0 <= zext_ln121_1_fu_170_p1(8 - 1 downto 0);
    ...
    grp_fu_376_p_din0 <= sum_squares_fu_56;
    grp_fu_376_p_din1 <= mul1_reg_278;
    grp_fu_376_p_opcode <= ap_const_lv2_0(1 - 1 downto 0);
    grp_fu_381_p_ce <= ap_const_logic_1;
    grp_fu_381_p_din0 <= tmp_4_reg_272;
    grp_fu_381_p_din1 <= tmp_4_reg_272;
    icmp_ln121_fu_154_p2 <= "1" when (signed(zext_ln121_fu_150_p1) < signed(n)) else "0";
    lshr_ln4_fu_160_p4 <= ap_sig_allocacmp_i_4(9 downto 2);
    sum_squares_out <= sum_squares_fu_56;

    sum_squares_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage5, icmp_ln121_reg_248, ap_loop_exit_ready, ap_block_pp0_stage5_11001)
    begin
        if (((ap_loop_exit_ready = ap_const_logic_1) and (icmp_ln121_reg_248 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage5_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage5))) then 
            sum_squares_out_ap_vld <= ap_const_logic_1;
        else 
            sum_squares_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    tmp_4_fu_186_p10 <= i_4_reg_242(2 - 1 downto 0);
    tmp_4_fu_186_p9 <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
    zext_ln121_1_fu_170_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(lshr_ln4_fu_160_p4),64));
    zext_ln121_fu_150_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_4),32));
end behav;
