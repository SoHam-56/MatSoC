...
module unpack_blk_to_stream_unpack_blk_to_stream_Pipeline_VITIS_LOOP_106_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [1:0] j_fu_74;
wire   [1:0] add_ln106_fu_150_p2;
wire    ap_loop_init;
reg   [1:0] ap_sig_allocacmp_j_1;
wire    ap_block_pp0_stage0;
reg    ap_block_pp0_stage0_01001_grp1;
wire   [2:0] zext_ln106_fu_140_p1;
wire   [0:0] icmp_ln120_fu_156_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln106_fu_144_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln106_fu_144_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln106_fu_150_p2 = (ap_sig_allocacmp_j_1 + 2'd1);
...
assign icmp_ln106_fu_144_p2 = (($signed(zext_ln106_fu_140_p1) < $signed(elements_in_block)) ? 1'b1 : 1'b0);

assign icmp_ln120_fu_156_p2 = ((zext_ln106_fu_140_p1 == sub18) ? 1'b1 : 1'b0);

assign out_pkt_last_fu_162_p2 = (icmp_ln120_fu_156_p2 & icmp_ln104);
...
assign zext_ln106_fu_140_p1 = ap_sig_allocacmp_j_1;

endmodule //unpack_blk_to_stream_unpack_blk_to_stream_Pipeline_VITIS_LOOP_106_2
