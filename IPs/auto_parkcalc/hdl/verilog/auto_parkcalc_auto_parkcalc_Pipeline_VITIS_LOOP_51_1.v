...
module auto_parkcalc_auto_parkcalc_Pipeline_VITIS_LOOP_51_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [31:0] A_blk_fu_212_p1;
reg    ap_block_state2_pp0_stage1_iter0_grp1;
reg    ap_block_pp0_stage1_11001_grp1;
wire   [31:0] A_blk_1_fu_218_p1;
wire   [31:0] bitcast_ln59_fu_224_p1;
wire   [31:0] A_blk_2_fu_234_p1;
reg    ap_block_pp0_stage2_11001_grp2;
wire   [31:0] A_blk_3_fu_240_p1;
wire   [31:0] bitcast_ln59_3_fu_246_p1;
wire   [31:0] A_blk_4_fu_256_p1;
reg    ap_block_pp0_stage0_11001_grp3;
wire   [31:0] A_blk_5_fu_262_p1;
wire   [31:0] bitcast_ln59_6_fu_268_p1;
wire   [31:0] grp_fu_124_p2;
reg   [31:0] product_reg_379;
wire   [31:0] grp_fu_129_p2;
reg   [31:0] product_1_reg_384;
wire   [31:0] grp_fu_134_p2;
reg   [31:0] product_2_reg_389;
wire   [31:0] grp_fu_139_p2;
reg   [31:0] product_3_reg_394;
wire   [31:0] grp_fu_144_p2;
reg   [31:0] product_4_reg_399;
wire   [31:0] grp_fu_149_p2;
reg   [31:0] product_5_reg_404;
reg   [31:0] product_6_reg_409;
reg   [31:0] product_6_reg_409_pp0_iter2_reg;
reg   [31:0] product_7_reg_414;
reg   [31:0] product_7_reg_414_pp0_iter2_reg;
reg   [31:0] product_8_reg_419;
reg   [31:0] product_8_reg_419_pp0_iter2_reg;
reg   [31:0] product_9_reg_424;
reg   [31:0] product_9_reg_424_pp0_iter2_reg;
reg   [31:0] product_10_reg_429;
reg   [31:0] product_10_reg_429_pp0_iter2_reg;
reg   [31:0] product_11_reg_434;
reg   [31:0] product_11_reg_434_pp0_iter2_reg;
reg   [31:0] product_12_reg_439;
reg   [31:0] product_12_reg_439_pp0_iter3_reg;
reg   [31:0] product_12_reg_439_pp0_iter4_reg;
reg   [31:0] product_13_reg_444;
reg   [31:0] product_13_reg_444_pp0_iter3_reg;
reg   [31:0] product_13_reg_444_pp0_iter4_reg;
reg   [31:0] product_14_reg_449;
reg   [31:0] product_14_reg_449_pp0_iter3_reg;
reg   [31:0] product_14_reg_449_pp0_iter4_reg;
reg   [31:0] product_15_reg_454;
reg   [31:0] product_15_reg_454_pp0_iter3_reg;
reg   [31:0] product_15_reg_454_pp0_iter4_reg;
reg   [31:0] product_16_reg_459;
reg   [31:0] product_16_reg_459_pp0_iter3_reg;
reg   [31:0] product_16_reg_459_pp0_iter4_reg;
reg   [31:0] product_17_reg_464;
reg   [31:0] product_17_reg_464_pp0_iter3_reg;
reg   [31:0] product_17_reg_464_pp0_iter4_reg;
wire   [31:0] grp_fu_94_p2;
reg   [31:0] ID_blk_reg_469;
wire    ap_block_pp0_stage0_11001_grp0;
reg    ap_block_pp0_stage0_subdone_grp0_done_reg;
wire    ap_block_pp0_stage0_subdone_grp0;
reg    ap_block_pp0_stage0_subdone;
wire   [31:0] grp_fu_99_p2;
reg   [31:0] IQ_blk_reg_474;
wire   [31:0] grp_fu_104_p2;
reg   [31:0] ID_blk_1_reg_479;
wire   [31:0] grp_fu_109_p2;
reg   [31:0] IQ_blk_1_reg_484;
wire   [31:0] grp_fu_114_p2;
reg   [31:0] add32_s_reg_489;
wire   [31:0] grp_fu_119_p2;
reg   [31:0] add38_277_1_reg_494;
reg   [31:0] ID_blk_2_reg_499;
wire    ap_block_pp0_stage2_11001_grp0;
reg    ap_block_pp0_stage2_subdone_grp0_done_reg;
wire    ap_block_pp0_stage2_subdone_grp0;
reg   [31:0] IQ_blk_2_reg_504;
reg   [31:0] ID_blk_3_reg_509;
reg   [31:0] IQ_blk_3_reg_514;
reg   [31:0] add32_1_2_reg_519;
reg   [31:0] add38_1_2_1_reg_524;
reg   [31:0] ID_blk_4_reg_529;
wire    ap_block_pp0_stage1_11001_grp0;
reg    ap_block_pp0_stage1_subdone_grp0_done_reg;
wire    ap_block_pp0_stage1_subdone_grp0;
reg    ap_block_pp0_stage1_subdone;
reg   [31:0] IQ_blk_4_reg_534;
reg   [31:0] ID_blk_5_reg_539;
reg   [31:0] IQ_blk_5_reg_544;
reg   [31:0] add32_2_2_reg_549;
reg   [31:0] add38_2_2_1_reg_554;
reg   [29:0] ib_fu_64;
wire   [29:0] add_ln51_fu_197_p2;
wire    ap_loop_init;
...
wire   [30:0] ib_cast_fu_187_p1;
wire   [31:0] trunc_ln59_fu_208_p1;
wire   [31:0] grp_fu_163_p3;
wire   [31:0] grp_fu_171_p3;
wire   [31:0] trunc_ln59_1_fu_230_p1;
wire   [31:0] trunc_ln59_2_fu_252_p1;
wire   [31:0] bitcast_ln75_2_fu_280_p1;
wire   [31:0] bitcast_ln75_1_fu_277_p1;
wire   [31:0] bitcast_ln75_fu_274_p1;
wire   [31:0] bitcast_ln76_2_fu_300_p1;
wire   [31:0] bitcast_ln76_1_fu_297_p1;
wire   [31:0] bitcast_ln76_fu_294_p1;
reg    grp_fu_94_ce;
...
auto_parkcalc_fadd_32ns_32ns_32_5_full_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 5 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
...
auto_parkcalc_fmul_32ns_32ns_32_4_max_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
...
auto_parkcalc_flow_control_loop_pipe_sequential_init flow_control_loop_pipe_sequential_init_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(ap_start),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln51_fu_191_p2 == 1'd1))) begin
...
always @ (*) begin
    if ((((ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage2_subdone_grp2_done_reg) & (1'b0 == ap_block_pp0_stage2_grp2) & (icmp_ln51_reg_321 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage2)) | ((ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage1_grp1) & (icmp_ln51_reg_321 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage1)) | ((1'b0 == ap_block_pp0_stage0_grp3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if ((((ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage2_subdone_grp2_done_reg) & (1'b0 == ap_block_pp0_stage2_11001_grp2) & (icmp_ln51_reg_321 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage2)) | ((ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage1_11001_grp1) & (icmp_ln51_reg_321 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage1)) | ((1'b0 == ap_block_pp0_stage0_11001_grp3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        A_ROW_TREADY = 1'b1;
    end else begin
        A_ROW_TREADY = 1'b0;
    end
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage2_subdone) & (icmp_ln51_reg_321 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
...
always @ (*) begin
    if ((((ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage2_grp2) & (1'b1 == ap_CS_fsm_pp0_stage2)) | ((1'b0 == ap_block_pp0_stage0_grp3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        grp_fu_124_p1 = 32'd3201367959;
    end else if (((ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage1_grp1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        grp_fu_124_p1 = 32'd1062274597;
    end else begin
        grp_fu_124_p1 = 'bx;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_grp3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        grp_fu_129_p1 = 32'd3207922817;
    end else if (((ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage2_grp2) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        grp_fu_129_p1 = 32'd1060439169;
    end else if (((ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage1_grp1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        grp_fu_129_p1 = 32'd0;
    end else begin
        grp_fu_129_p1 = 'bx;
...
always @ (*) begin
    if ((((ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage2_grp2) & (1'b1 == ap_CS_fsm_pp0_stage2)) | ((1'b0 == ap_block_pp0_stage0_grp3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        grp_fu_134_p1 = 32'd3201367959;
    end else if (((ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage1_grp1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        grp_fu_134_p1 = 32'd1062274597;
    end else begin
        grp_fu_134_p1 = 'bx;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_grp3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        grp_fu_139_p1 = 32'd3207922817;
    end else if (((ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage2_grp2) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        grp_fu_139_p1 = 32'd1060439169;
    end else if (((ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage1_grp1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        grp_fu_139_p1 = 32'd0;
    end else begin
        grp_fu_139_p1 = 'bx;
...
always @ (*) begin
    if ((((ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage2_grp2) & (1'b1 == ap_CS_fsm_pp0_stage2)) | ((1'b0 == ap_block_pp0_stage0_grp3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        grp_fu_144_p1 = 32'd3201367959;
    end else if (((ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage1_grp1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        grp_fu_144_p1 = 32'd1062274597;
    end else begin
        grp_fu_144_p1 = 'bx;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_grp3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        grp_fu_149_p1 = 32'd3207922817;
    end else if (((ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage2_grp2) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        grp_fu_149_p1 = 32'd1060439169;
    end else if (((ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage1_grp1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        grp_fu_149_p1 = 32'd0;
    end else begin
        grp_fu_149_p1 = 'bx;
...
assign A_blk_1_fu_218_p1 = grp_fu_163_p3;

assign A_blk_2_fu_234_p1 = trunc_ln59_1_fu_230_p1;

assign A_blk_3_fu_240_p1 = grp_fu_163_p3;

assign A_blk_4_fu_256_p1 = trunc_ln59_2_fu_252_p1;

assign A_blk_5_fu_262_p1 = grp_fu_163_p3;

assign A_blk_fu_212_p1 = trunc_ln59_fu_208_p1;

assign ID_TDATA = {{{bitcast_ln75_2_fu_280_p1}, {bitcast_ln75_1_fu_277_p1}}, {bitcast_ln75_fu_274_p1}};

assign IQ_TDATA = {{{bitcast_ln76_2_fu_300_p1}, {bitcast_ln76_1_fu_297_p1}}, {bitcast_ln76_fu_294_p1}};

assign add_ln51_fu_197_p2 = (ap_sig_allocacmp_ib_load + 30'd1);
...
always @ (*) begin
    ap_block_pp0_stage2_01001_grp5 = ((1'b0 == ap_block_pp0_stage2_subdone_grp5_done_reg) & (ap_enable_reg_pp0_iter6 == 1'b1) & (1'b0 == IQ_TREADY));
end

always @ (*) begin
    ap_block_pp0_stage2_11001 = (((ap_enable_reg_pp0_iter6 == 1'b1) & (((1'b0 == ap_block_pp0_stage2_subdone_grp5_done_reg) & (1'b0 == IQ_TREADY)) | ((1'b0 == ap_block_pp0_stage2_subdone_grp4_done_reg) & (1'b0 == ID_TREADY)))) | ((ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage2_subdone_grp2_done_reg) & (1'b1 == ap_block_state3_pp0_stage2_iter0_grp2)));
end
...
always @ (*) begin
    ap_block_pp0_stage2_11001_grp5 = ((1'b0 == ap_block_pp0_stage2_subdone_grp5_done_reg) & (ap_enable_reg_pp0_iter6 == 1'b1) & (1'b0 == IQ_TREADY));
end
...
always @ (*) begin
    ap_block_pp0_stage2_subdone_grp5 = ((1'b0 == ap_block_pp0_stage2_subdone_grp5_done_reg) & (ap_enable_reg_pp0_iter6 == 1'b1) & (1'b0 == IQ_TREADY));
end

always @ (*) begin
    ap_block_state2_pp0_stage1_iter0_grp1 = ((icmp_ln51_reg_321 == 1'd1) & (1'b0 == A_ROW_TVALID));
end

always @ (*) begin
    ap_block_state3_pp0_stage2_iter0_grp2 = ((icmp_ln51_reg_321 == 1'd1) & (1'b0 == A_ROW_TVALID));
end
...
assign bitcast_ln59_3_fu_246_p1 = grp_fu_171_p3;

assign bitcast_ln59_6_fu_268_p1 = grp_fu_171_p3;

assign bitcast_ln59_fu_224_p1 = grp_fu_171_p3;

assign bitcast_ln75_1_fu_277_p1 = ID_blk_5_reg_539;

assign bitcast_ln75_2_fu_280_p1 = add32_2_2_reg_549;

assign bitcast_ln75_fu_274_p1 = ID_blk_4_reg_529;

assign bitcast_ln76_1_fu_297_p1 = IQ_blk_5_reg_544;

assign bitcast_ln76_2_fu_300_p1 = add38_2_2_1_reg_554;

assign bitcast_ln76_fu_294_p1 = IQ_blk_4_reg_534;

assign grp_fu_163_p3 = {{A_ROW_TDATA[63:32]}};

assign grp_fu_171_p3 = {{A_ROW_TDATA[95:64]}};

assign ib_cast_fu_187_p1 = ap_sig_allocacmp_ib_load;

assign icmp_ln51_fu_191_p2 = (($signed(ib_cast_fu_187_p1) < $signed(select_ln50_1)) ? 1'b1 : 1'b0);

assign trunc_ln59_1_fu_230_p1 = A_ROW_TDATA[31:0];

assign trunc_ln59_2_fu_252_p1 = A_ROW_TDATA[31:0];

assign trunc_ln59_fu_208_p1 = A_ROW_TDATA[31:0];

endmodule //auto_parkcalc_auto_parkcalc_Pipeline_VITIS_LOOP_51_1
