...
wire  signed [31:0] add_ln44_fu_141_p2;
reg  signed [31:0] add_ln44_reg_330;
reg   [0:0] tmp_2_reg_335;
wire    ap_CS_fsm_state2;
wire   [64:0] grp_fu_136_p2;
reg   [64:0] mul_ln44_reg_346;
wire    ap_CS_fsm_state3;
reg   [29:0] tmp_3_cast_reg_351;
wire   [29:0] select_ln44_fu_195_p3;
reg   [29:0] select_ln44_reg_356;
wire    ap_CS_fsm_state4;
wire   [30:0] select_ln44_1_fu_210_p3;
reg   [30:0] select_ln44_1_reg_361;
...
wire    grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118_ap_start;
wire    grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118_ap_done;
wire    grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118_ap_idle;
wire    grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118_ap_ready;
wire    grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118_output_stream_TREADY;
wire   [31:0] grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118_output_stream_TDATA;
wire    grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118_output_stream_TVALID;
wire   [3:0] grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118_output_stream_TKEEP;
wire   [3:0] grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118_output_stream_TSTRB;
wire   [0:0] grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118_output_stream_TLAST;
reg    grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118_ap_start_reg;
...
wire   [0:0] icmp_ln47_fu_248_p2;
wire   [33:0] grp_fu_136_p1;
wire   [2:0] grp_fu_155_p1;
wire   [64:0] sub_ln44_fu_180_p2;
wire   [29:0] tmp_2_cast_fu_185_p4;
wire   [30:0] zext_ln44_fu_201_p1;
wire   [30:0] sub_ln44_1_fu_204_p2;
wire   [2:0] grp_fu_155_p2;
wire   [2:0] trunc_ln45_fu_217_p1;
wire   [0:0] icmp_ln45_fu_221_p2;
wire   [30:0] zext_ln47_fu_244_p1;
wire   [31:0] trunc_ln48_fu_269_p1;
...
initial begin
#0 ap_CS_fsm = 40'd1;
#0 grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118_ap_start_reg = 1'b0;
#0 blk_count_fu_102 = 30'd0;
end

unpack_blk_to_stream_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2 grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118_ap_start_reg <= 1'b0;
    end else begin
        if (((blk_stream_TVALID_int_regslice == 1'b1) & (1'b1 == ap_CS_fsm_state38))) begin
            grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118_ap_start_reg <= 1'b1;
        end else if ((grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118_ap_ready == 1'b1)) begin
            grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    ...
    end else if (((icmp_ln47_fu_248_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state37))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        ...
        tmp_2_reg_335 <= add_ln44_fu_141_p2[32'd31];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state39) & (grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118_output_stream_TVALID == 1'b1))) begin
...
always @ (*) begin
    if ((grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118_ap_done == 1'b0)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state37 : begin
            if (((icmp_ln47_fu_248_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state37))) begin
        ...
        ap_ST_fsm_state39 : begin
            if (((1'b1 == ap_CS_fsm_state39) & (grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118_ap_done == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_state37;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state39;
            end
...
assign add_ln44_fu_141_p2 = (n + 32'd2);
...
assign elements_in_block_fu_304_p3 = ((icmp_ln51_reg_379[0:0] == 1'b1) ? last_block_size_reg_366 : 3'd3);

assign grp_fu_136_p1 = 65'd5726623062;

assign grp_fu_155_p1 = 32'd3;

assign grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118_ap_start = grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118_ap_start_reg;

assign grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118_output_stream_TREADY = (output_stream_TREADY_int_regslice & ap_CS_fsm_state39);

assign icmp_ln45_fu_221_p2 = ((trunc_ln45_fu_217_p1 == 3'd0) ? 1'b1 : 1'b0);

assign icmp_ln47_fu_248_p2 = (($signed(zext_ln47_fu_244_p1) < $signed(select_ln44_1_reg_361)) ? 1'b1 : 1'b0);

assign icmp_ln51_fu_259_p2 = ((zext_ln47_fu_244_p1 == sub3_reg_371) ? 1'b1 : 1'b0);

assign last_block_size_fu_227_p3 = ((icmp_ln45_fu_221_p2[0:0] == 1'b1) ? 3'd3 : trunc_ln45_fu_217_p1);

assign output_stream_TVALID = regslice_both_output_stream_V_data_V_U_vld_out;

assign output_stream_TVALID_int_regslice = grp_unpack_blk_to_stream_Pipeline_VITIS_LOOP_53_2_fu_118_output_stream_TVALID;

assign select_ln44_1_fu_210_p3 = ((tmp_2_reg_335[0:0] == 1'b1) ? sub_ln44_1_fu_204_p2 : zext_ln44_fu_201_p1);

assign select_ln44_fu_195_p3 = ((tmp_2_reg_335[0:0] == 1'b1) ? tmp_2_cast_fu_185_p4 : tmp_3_cast_reg_351);

assign sub18_fu_311_p2 = ($signed(elements_in_block_fu_304_p3) + $signed(3'd7));

assign sub3_fu_235_p2 = ($signed(select_ln44_1_fu_210_p3) + $signed(31'd2147483647));

assign sub_ln44_1_fu_204_p2 = (31'd0 - zext_ln44_fu_201_p1);

assign sub_ln44_fu_180_p2 = (65'd0 - mul_ln44_reg_346);

assign temp_blk_1_fu_286_p1 = tmp_fu_278_p3;

assign temp_blk_2_fu_299_p1 = tmp_1_fu_291_p3;

assign temp_blk_fu_273_p1 = trunc_ln48_fu_269_p1;

assign tmp_1_fu_291_p3 = {{blk_stream_TDATA_int_regslice[95:64]}};

assign tmp_2_cast_fu_185_p4 = {{sub_ln44_fu_180_p2[63:34]}};

assign tmp_fu_278_p3 = {{blk_stream_TDATA_int_regslice[63:32]}};

assign trunc_ln45_fu_217_p1 = grp_fu_155_p2[2:0];

assign trunc_ln48_fu_269_p1 = blk_stream_TDATA_int_regslice[31:0];

assign zext_ln44_fu_201_p1 = select_ln44_reg_356;

assign zext_ln47_fu_244_p1 = blk_count_fu_102;
