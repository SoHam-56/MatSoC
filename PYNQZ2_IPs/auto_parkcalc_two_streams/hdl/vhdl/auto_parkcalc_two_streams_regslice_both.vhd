...
entity auto_parkcalc_two_streams_regslice_both is
    generic (
        DataWidth   : INTEGER := 8);
    port (
        -- system signals
...
end entity auto_parkcalc_two_streams_regslice_both;

architecture behave of auto_parkcalc_two_streams_regslice_both is
