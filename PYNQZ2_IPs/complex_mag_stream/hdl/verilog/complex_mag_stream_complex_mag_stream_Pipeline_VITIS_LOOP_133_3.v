...
module complex_mag_stream_complex_mag_stream_Pipeline_VITIS_LOOP_133_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_ready_int;
reg   [2:0] j_fu_52;
wire   [2:0] add_ln133_fu_175_p2;
wire    ap_loop_init;
reg   [2:0] ap_sig_allocacmp_j_1;
reg   [31:0] out_blk_0_0_load34_fu_56;
wire   [1:0] trunc_ln133_fu_156_p1;
reg   [31:0] out_blk_0_1_load41_fu_60;
reg   [31:0] out_blk_0_2_load48_fu_64;
wire  signed [2:0] sext_ln133_fu_146_p0;
wire  signed [3:0] sext_ln133_fu_146_p1;
wire   [3:0] zext_ln110_cast_fu_119_p1;
wire  signed [2:0] trunc_ln133_fu_156_p0;
wire  signed [2:0] add_ln133_fu_175_p0;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln133_fu_150_p2 == 1'd0)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        if (((trunc_ln133_fu_156_p1 == 2'd0) & (icmp_ln133_fu_150_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        if (((trunc_ln133_fu_156_p1 == 2'd1) & (icmp_ln133_fu_150_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((icmp_ln133_fu_150_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln133_fu_150_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln133_fu_175_p0 = ap_sig_allocacmp_j_1;

assign add_ln133_fu_175_p2 = ($signed(add_ln133_fu_175_p0) + $signed(3'd1));
...
always @ (*) begin
    ap_condition_83 = (~(trunc_ln133_fu_156_p1 == 2'd1) & ~(trunc_ln133_fu_156_p1 == 2'd0) & (icmp_ln133_fu_150_p2 == 1'd0));
end
...
assign icmp_ln133_fu_150_p2 = ((sext_ln133_fu_146_p1 == zext_ln110_cast_fu_119_p1) ? 1'b1 : 1'b0);
...
assign sext_ln133_fu_146_p0 = ap_sig_allocacmp_j_1;

assign sext_ln133_fu_146_p1 = sext_ln133_fu_146_p0;

assign trunc_ln133_fu_156_p0 = ap_sig_allocacmp_j_1;

assign trunc_ln133_fu_156_p1 = trunc_ln133_fu_156_p0[1:0];

assign zext_ln110_cast_fu_119_p1 = zext_ln110;

endmodule //complex_mag_stream_complex_mag_stream_Pipeline_VITIS_LOOP_133_3
