...
-- Date        : Tue Feb 18 04:15:43 2025
-- Host        : archlinux running 64-bit Arch Linux
-- Command     : write_vhdl -force -mode synth_stub
--               /home/admin/Desktop/SOCExtraFeatures/PYNQZ2_VIVADO/MotorFault_PYNQZ2.gen/sources_1/bd/MotorFatigue_PYNQZ2/ip/MotorFatigue_PYNQZ2_calculate_statistics_0_0/MotorFatigue_PYNQZ2_calculate_statistics_0_0_stub.vhdl
...
entity MotorFatigue_PYNQZ2_calculate_statistics_0_0 is
  Port ( 
  ...
  attribute CHECK_LICENSE_TYPE of MotorFatigue_PYNQZ2_calculate_statistics_0_0 : entity is "MotorFatigue_PYNQZ2_calculate_statistics_0_0,calculate_statistics,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of MotorFatigue_PYNQZ2_calculate_statistics_0_0 : entity is "MotorFatigue_PYNQZ2_calculate_statistics_0_0,calculate_statistics,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=calculate_statistics,x_ipVersion=1.0,x_ipCoreRevision=2113959951,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S_AXI_CTRL_ADDR_WIDTH=5,C_S_AXI_CTRL_DATA_WIDTH=32}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of MotorFatigue_PYNQZ2_calculate_statistics_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of MotorFatigue_PYNQZ2_calculate_statistics_0_0 : entity is "HLS";
  attribute hls_module : string;
  attribute hls_module of MotorFatigue_PYNQZ2_calculate_statistics_0_0 : entity is "yes";
end MotorFatigue_PYNQZ2_calculate_statistics_0_0;

architecture stub of MotorFatigue_PYNQZ2_calculate_statistics_0_0 is
  attribute syn_black_box : boolean;
  attribute black_box_pad_pin : string;
  attribute syn_black_box of stub : architecture is true;
  attribute black_box_pad_pin of stub : architecture is "s_axi_CTRL_ARADDR[4:0],s_axi_CTRL_ARREADY,s_axi_CTRL_ARVALID,s_axi_CTRL_AWADDR[4:0],s_axi_CTRL_AWREADY,s_axi_CTRL_AWVALID,s_axi_CTRL_BREADY,s_axi_CTRL_BRESP[1:0],s_axi_CTRL_BVALID,s_axi_CTRL_RDATA[31:0],s_axi_CTRL_RREADY,s_axi_CTRL_RRESP[1:0],s_axi_CTRL_RVALID,s_axi_CTRL_WDATA[31:0],s_axi_CTRL_WREADY,s_axi_CTRL_WSTRB[3:0],s_axi_CTRL_WVALID,ap_clk,ap_rst_n,interrupt,input_stream_TDATA[31:0],input_stream_TKEEP[3:0],input_stream_TLAST[0:0],input_stream_TREADY,input_stream_TSTRB[3:0],input_stream_TVALID,output_stream_TDATA[31:0],output_stream_TKEEP[3:0],output_stream_TLAST[0:0],output_stream_TREADY,output_stream_TSTRB[3:0],output_stream_TVALID";
  ...
  attribute X_INTERFACE_PARAMETER of ap_clk : signal is "XIL_INTERFACENAME ap_clk, ASSOCIATED_BUSIF s_axi_CTRL:input_stream:output_stream, ASSOCIATED_RESET ap_rst_n, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN MotorFatigue_PYNQZ2_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
  ...
  attribute X_CORE_INFO of stub : architecture is "calculate_statistics,Vivado 2024.2";
begin
end;
