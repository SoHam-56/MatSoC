...
void auto_parkcalc(int size, hls::stream<blk>& A_ROW, hls::stream<blk>& ID, hls::stream<blk>& IQ, hls::stream<blk>& IO);
void unpack_blk_to_stream(int n, hls::stream<blk>& blk_stream, hls::stream<axis_pkt>& output_stream);
void complex_mag_stream(int n, hls::stream<axis_pkt>& input_stream_id,
                       hls::stream<axis_pkt>& input_stream_iq,
                       hls::stream<axis_pkt>& output_stream);
