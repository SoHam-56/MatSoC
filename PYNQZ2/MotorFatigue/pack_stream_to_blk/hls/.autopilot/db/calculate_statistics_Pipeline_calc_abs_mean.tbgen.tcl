set moduleName calculate_statistics_Pipeline_calc_abs_mean
set isTopModule 0
...
set cdfgNum 11
set C_modelName {calculate_statistics_Pipeline_calc_abs_mean}
...
set C_modelArgList {
	...
	{ abs_sum_out float 32 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "n", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "abs_sum_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ abs_sum_out sc_out sc_lv 32 signal 5 } 
	{ abs_sum_out_ap_vld sc_out sc_logic 1 outvld 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "abs_sum_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "abs_sum_out", "role": "default" }} , 
 	{ "name": "abs_sum_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "abs_sum_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_9_2_32_1_1_U50", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	abs_sum_out { ap_vld {  { abs_sum_out out_data 1 32 }  { abs_sum_out_ap_vld out_vld 1 1 } } }
}
