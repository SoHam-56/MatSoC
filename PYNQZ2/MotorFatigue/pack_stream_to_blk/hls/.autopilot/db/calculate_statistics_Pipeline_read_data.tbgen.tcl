set moduleName calculate_statistics_Pipeline_read_data
set isTopModule 0
...
set cdfgNum 11
set C_modelName {calculate_statistics_Pipeline_read_data}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict data_3 { MEM_WIDTH 32 MEM_SIZE 1024 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict data_2 { MEM_WIDTH 32 MEM_SIZE 1024 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict data_1 { MEM_WIDTH 32 MEM_SIZE 1024 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict data { MEM_WIDTH 32 MEM_SIZE 1024 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ empty int 31 regular  }
	{ data_3 float 32 regular {array 256 { 0 3 } 0 1 }  }
	{ data_2 float 32 regular {array 256 { 0 3 } 0 1 }  }
	{ data_1 float 32 regular {array 256 { 0 3 } 0 1 }  }
	{ data float 32 regular {array 256 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ data_3_address0 sc_out sc_lv 8 signal 1 } 
	{ data_3_ce0 sc_out sc_logic 1 signal 1 } 
	{ data_3_we0 sc_out sc_logic 1 signal 1 } 
	{ data_3_d0 sc_out sc_lv 32 signal 1 } 
	{ data_2_address0 sc_out sc_lv 8 signal 2 } 
	...
	{ data_1_we0 sc_out sc_logic 1 signal 3 } 
	{ data_1_d0 sc_out sc_lv 32 signal 3 } 
	...
	{ input_stream_TDATA sc_in sc_lv 32 signal 5 } 
	{ input_stream_TREADY sc_out sc_logic 1 inacc 8 } 
	{ input_stream_TKEEP sc_in sc_lv 4 signal 6 } 
	{ input_stream_TSTRB sc_in sc_lv 4 signal 7 } 
	{ input_stream_TLAST sc_in sc_lv 1 signal 8 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	data_3 { ap_memory {  { data_3_address0 mem_address 1 8 }  { data_3_ce0 mem_ce 1 1 }  { data_3_we0 mem_we 1 1 }  { data_3_d0 mem_din 1 32 } } }
	data_2 { ap_memory {  { data_2_address0 mem_address 1 8 }  { data_2_ce0 mem_ce 1 1 }  { data_2_we0 mem_we 1 1 }  { data_2_d0 mem_din 1 32 } } }
	data_1 { ap_memory {  { data_1_address0 mem_address 1 8 }  { data_1_ce0 mem_ce 1 1 }  { data_1_we0 mem_we 1 1 }  { data_1_d0 mem_din 1 32 } } }
	data { ap_memory {  { data_address0 mem_address 1 8 }  { data_ce0 mem_ce 1 1 }  { data_we0 mem_we 1 1 }  { data_d0 mem_din 1 32 } } }
