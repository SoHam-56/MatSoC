set moduleName calculate_statistics_Pipeline_write_results
set isTopModule 0
...
set cdfgNum 11
set C_modelName {calculate_statistics_Pipeline_write_results}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict results { MEM_WIDTH 32 MEM_SIZE 44 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ results float 32 regular {array 11 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "results", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ results_address0 sc_out sc_lv 4 signal 0 } 
	{ results_ce0 sc_out sc_logic 1 signal 0 } 
	{ results_q0 sc_in sc_lv 32 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "results_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "results", "role": "address0" }} , 
 	{ "name": "results_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "results", "role": "ce0" }} , 
 	{ "name": "results_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "results", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	results { ap_memory {  { results_address0 mem_address 1 4 }  { results_ce0 mem_ce 1 1 }  { results_q0 mem_dout 0 32 } } }
