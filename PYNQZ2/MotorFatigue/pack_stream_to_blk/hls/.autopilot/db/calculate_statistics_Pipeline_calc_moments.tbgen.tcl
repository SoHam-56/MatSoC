set moduleName calculate_statistics_Pipeline_calc_moments
set isTopModule 0
...
set cdfgNum 11
set C_modelName {calculate_statistics_Pipeline_calc_moments}
...
set C_modelArgList {
	...
	{ std_dev float 32 regular  }
	{ kurt_accum_out float 32 regular {pointer 1}  }
	{ skew_accum_out float 32 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "n", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "std_dev", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "kurt_accum_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "skew_accum_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ std_dev sc_in sc_lv 32 signal 6 } 
	{ kurt_accum_out sc_out sc_lv 32 signal 7 } 
	{ kurt_accum_out_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ skew_accum_out sc_out sc_lv 32 signal 8 } 
	{ skew_accum_out_ap_vld sc_out sc_logic 1 outvld 8 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "std_dev", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "std_dev", "role": "default" }} , 
 	{ "name": "kurt_accum_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "kurt_accum_out", "role": "default" }} , 
 	{ "name": "kurt_accum_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "kurt_accum_out", "role": "ap_vld" }} , 
 	{ "name": "skew_accum_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "skew_accum_out", "role": "default" }} , 
 	{ "name": "skew_accum_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "skew_accum_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_9_2_32_1_1_U60", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	std_dev { ap_none {  { std_dev in_data 0 32 } } }
	kurt_accum_out { ap_vld {  { kurt_accum_out out_data 1 32 }  { kurt_accum_out_ap_vld out_vld 1 1 } } }
	skew_accum_out { ap_vld {  { skew_accum_out out_data 1 32 }  { skew_accum_out_ap_vld out_vld 1 1 } } }
}
